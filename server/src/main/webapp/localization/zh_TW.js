...
document.localization ['zh_TW'] = {
    ...
    'form.configuration.settings.show.info.button': '在啟動器中顯示資訊按鈕',
    'form.configuration.settings.show.info.button.hint': '停用時，裝置上的資訊按鈕（IMEI、序號等）將被隱藏',
    'form.configuration.settings.show.update.button': '在啟動器中顯示更新按鈕',
    'form.configuration.settings.show.update.button.hint': '停用時，裝置上的更新/下載按鈕（觸發MDM代理更新）將被隱藏',
