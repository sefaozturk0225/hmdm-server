...
document.localization ['fr_FR'] = {
    ...
    'form.configuration.settings.show.info.button': 'Afficher le bouton Info dans le lanceur',
    'form.configuration.settings.show.info.button.hint': 'Si désactivé, le bouton Info (IMEI, numéro de série, etc.) est masqué sur l'appareil',
    'form.configuration.settings.show.update.button': 'Afficher le bouton Mise à jour dans le lanceur',
    'form.configuration.settings.show.update.button.hint': 'Si désactivé, le bouton Mise à jour/Téléchargement (déclenche la mise à jour de l'agent MDM) est masqué',
...
'form.application.setting.app': 'Application',
    ...
    'app.description': 'est une plateforme MDM de Tahirova Teknoloji',
    ...
    'about.line.2': 'Plateforme MDM Tahirova Teknoloji',
