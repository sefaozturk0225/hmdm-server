...
document.localization ['ja_JP'] = {
    ...
    'form.configuration.settings.show.info.button': 'ランチャーにInfoボタンを表示',
    'form.configuration.settings.show.info.button.hint': '無効にすると、デバイス上のInfoボタン（IMEI、シリアル番号など）が非表示になります',
    'form.configuration.settings.show.update.button': 'ランチャーに更新ボタンを表示',
    'form.configuration.settings.show.update.button.hint': '無効にすると、デバイス上の更新/ダウンロードボタン（MDMエージェント更新）が非表示になります',
