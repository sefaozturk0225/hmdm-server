...
document.localization[ 'ru_RU' ] = {
    ...
    'form.configuration.settings.show.info.button': 'Показать кнопку «Инфо» в приложении',
    'form.configuration.settings.show.info.button.hint': 'Если отключено, кнопка «Инфо» (IMEI, серийный номер и т.д.) будет скрыта на устройстве',
    'form.configuration.settings.show.update.button': 'Показать кнопку «Обновление» в приложении',
    'form.configuration.settings.show.update.button.hint': 'Если отключено, кнопка «Обновить/Загрузить» (обновление MDM-агента) будет скрыта на устройстве',
