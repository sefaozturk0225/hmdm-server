...
document.localization ['pt_PT'] = {
    ...
    'form.configuration.settings.show.info.button': 'Mostrar botão Info no launcher',
    'form.configuration.settings.show.info.button.hint': 'Quando desativado, o botão Info (IMEI, número de série, etc.) fica oculto no dispositivo',
    'form.configuration.settings.show.update.button': 'Mostrar botão Atualizar no launcher',
    'form.configuration.settings.show.update.button.hint': 'Quando desativado, o botão Atualizar/Download (atualização do agente MDM) fica oculto no dispositivo',
    ...
    'app.description': 'é uma plataforma MDM da Tahirova Teknoloji',
