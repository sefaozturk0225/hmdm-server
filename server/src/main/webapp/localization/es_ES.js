...
document.localization ['es_ES'] = {
    ...
    'form.configuration.settings.show.info.button': 'Mostrar botón Info en el lanzador',
    'form.configuration.settings.show.info.button.hint': 'Si está desactivado, el botón Info (IMEI, número de serie, etc.) se oculta en el dispositivo',
    'form.configuration.settings.show.update.button': 'Mostrar botón Actualizar en el lanzador',
    'form.configuration.settings.show.update.button.hint': 'Si está desactivado, el botón Actualizar/Descargar (activa la actualización del agente MDM) se oculta',
