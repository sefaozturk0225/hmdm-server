...
document.localization ['en_US'] = {
    ...
    'form.configuration.settings.show.info.button': 'Show Info button on launcher',
    'form.configuration.settings.show.info.button.hint': 'When disabled, the Info button (shows IMEI, serial, etc.) is hidden on the device',
    'form.configuration.settings.show.update.button': 'Show Update button on launcher',
    'form.configuration.settings.show.update.button.hint': 'When disabled, the Update/Download button (triggers MDM agent update) is hidden on the device',
    ...
    'proposal.modal.profil.telefon': 'Phone',
    'proposal.modal.profil.sinavPaketi': 'Exam Package'
};
