...
document.localization ['zh_CN'] = {
    ...
    'form.configuration.settings.show.info.button': '在启动器中显示信息按钮',
    'form.configuration.settings.show.info.button.hint': '禁用时，设备上的信息按钮（IMEI、序列号等）将被隐藏',
    'form.configuration.settings.show.update.button': '在启动器中显示更新按钮',
    'form.configuration.settings.show.update.button.hint': '禁用时，设备上的更新/下载按钮（触发MDM代理更新）将被隐藏',
